...
add_action(
	...
	function () {
		new Updater(
			plugin_basename( UNITONE_SEARCH_PATH . '/unitone-search.php' ),
			'inc2734',
			'unitone-search',
			array(
 ...
 */
add_filter(
	'inc2734_github_plugin_updater_zip_url_inc2734/unitone-search',
	function ( $url ) {
 ...
 * Access https://unitone.2inc.org/wp-json/unitone-license-manager/v1/update/...?repository=unitone-search
 * and return json after authentication passes.
 *
 * @return string
 */
add_filter(
	'inc2734_github_plugin_updater_request_url_inc2734/unitone-search',
	function () {
		$license_key = Manager::get_option( 'license-key' );
		return sprintf(
			'https://unitone.2inc.org/wp-json/unitone-license-manager/v1/update/%1$s?repository=unitone-search',
